...
pinMode(LEFT_PIN2, INPUT_PULLUP);
  pinMode(CENTER_PIN2, INPUT_PULLUP);
...
if (digitalRead(LEFT_PIN) == 0) {
   ...
   else if (digitalRead(CENTER_PIN) == 0) {
   ...
   else if (digitalRead(LEFT_PIN2) == 0) {
   
    stepper1.moveTo(pos);
    stepper1.run(); 
    }

   else if (digitalRead(RIGHT_PIN2) == 0) {
   
    stepper1.moveTo(-pos);
    stepper1.run(); 
    }

   else if (digitalRead(CENTER_PIN2) == 0) {
